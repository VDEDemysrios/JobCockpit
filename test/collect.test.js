...
// À quota limité, mieux vaut analyser les offres que l'auteur va vraiment
...
// analyse tout ce qu'elle peut le vide entièrement — et l'auteur se retrouve
...
test('le nettoyage automatique ne touche jamais une offre suivie', async () => {
  ...
  // l'auteur l'annote — c'est ce geste qui doit la sauver.
