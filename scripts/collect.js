...
export async function collecter({
  ...
  // Ce que l'auteur a écarté pour de bon ne doit pas revenir. L'identifiant
  ...
  if (analyser) {
    ...
    // limité, on analyse d'abord celles que l'auteur va réellement ouvrir :
    ...
    // rien pour écrire une lettre au moment où l'auteur en veut une.
    //
